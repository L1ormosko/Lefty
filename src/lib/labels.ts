...
const he: Dict = {
  ...
  "landing.title": "VELTO",
  "landing.headline": "שטחי פרסום חוץ בישראל, במקום אחד",
  "landing.sub": "מצאו, השוו ובקשו זמינות לשלטי חוצות, מסכים דיגיטליים ועוד — ישירות מבעלי השטח, בלי סבב טלפונים.",
  "landing.ctaExplore": "גלו שטחי פרסום",
  "landing.ctaOwner": "פרסמו את השטח שלכם",
  "landing.inventoryNote": "מלאי פעיל ב-{count} ערים ברחבי הארץ",
  "landing.advertiserTitle": "למפרסמים ולמשרדי פרסום",
  "landing.advertiserStep1Title": "חיפוש על המפה",
  "landing.advertiserStep1Body": "סננו לפי עיר, סוג שטח, תאריכים ותקציב, וראו זמינות אמיתית.",
  "landing.advertiserStep2Title": "בדיקת זמינות ומחיר",
  "landing.advertiserStep2Body": "בחרו תאריכים ושלחו בקשה ישירות לבעל השטח — בלי מתווכים.",
  "landing.advertiserStep3Title": "מעקב אחרי הבקשה",
  "landing.advertiserStep3Body": "כל הבקשות וההזמנות שלכם במקום אחד, באזור האישי.",
  "landing.ownerTitle": "לבעלי שטחי פרסום",
  "landing.ownerStep1Title": "פרסום השטח",
  "landing.ownerStep1Body": "מיקום, מפרט, תמונות ומחיר — תוך כמה דקות, בלי טפסים ארוכים.",
  "landing.ownerStep2Title": "אימות מול VELTO",
  "landing.ownerStep2Body": "כל שטח עובר בדיקה לפני שהוא מוצג כמאומת למפרסמים.",
  "landing.ownerStep3Title": "קבלת פניות",
  "landing.ownerStep3Body": "בקשות זמינות והזמנות מגיעות אליכם — אתם מאשרים או דוחים.",
  "landing.trustTitle": "שקיפות לפני הכול",
  "landing.trustBody": "כל שטח מסומן בסטטוס אימות וזמינות אמיתיים. מידע שלא סופק מוצג ככזה — אנחנו לא ממציאים מחירים, זמינות או נתוני קהל.",
